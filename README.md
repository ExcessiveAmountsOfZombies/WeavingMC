# WeavingMC
Fabric server event system &amp; more?
...
# Credit
this event system uses code based based on lahwran's fast events and then modified a bit to allow for annotation based priority and cancellation similar to forge/bukkit actually.
